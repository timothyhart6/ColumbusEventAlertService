...
@Slf4j
public class NewportEventServiceImpl extends EventServiceImpl{
    public NewportEventServiceImpl(String url, JsoupService jsoupService, DateUtil dateUtil, String locationName) {
